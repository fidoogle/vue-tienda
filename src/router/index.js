      ...
      children: [
        {
          ...
          meta: { Auth: true, title: "Adminstrar Usuarios", role: "admin" }
        },
        {
          path: "products",
          component: AdminProducts,
          meta: { Auth: true, title: "Adminstrar Productos", role: "admin" }
        },
        {
          path: "chart_orders",
          component: AdminChartOrders,
          meta: { Auth: true, title: "Gráfica de pedidos", role: "admin" }
        }
      ]
    },
    {
